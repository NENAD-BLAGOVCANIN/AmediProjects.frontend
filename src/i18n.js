    ...
    resources: {
      ...
      he: {
        translation: {
          ...
          "email": "אימייל",
          "last_execution_date": "תאריך ביצוע אחרון",
          "agreed_payment_date": "תאריך תשלום מוסכם",
          "contact_person": "איש קשר",
          "debt": "חוב",
          "first_line_sent_whatsapp": "שורת ראשונה נשלחה בוואטסאפ",
          "details": "פרטים",
          "second_line_sent_email_details": "פרטי דוא\"ל שנשלחו בשורה שנייה",
          "details_2": "פרטים 2",
          "call_2_created": "שיחה 2 נוצרה",
          "collected_amount": "סכום שנאסף",
          "remaining_amount_to_collect": "יתרה לאסוף",
          "company_name": "שם החברה",
          "cumulative_offset": "קיזוז מצטבר",
          "offset_instead_of_guarantee": "קיזוז במקום ערבון",
          "payment_status": "מצב תשלום",
          "last_connection": "תקשורת אחרונה",
          "update": "עדכן",
          "save": "שמור",
          "close": "סגור",
          "check":"צ'ק",
          ...
          "select_payment_status":"בחר סטטוס תשלום"
        },
      },
      isRTL: true
    }
